...
export function RadiologyWorkspace() {
  ...
  const createRequest = async (event: FormEvent) => {
    ...
    try {
      ...
      setSelectedId(id);
      await refresh();
      toast({ title: "Imaging requested", variant: "success" });
    } catch (error) {
  ...
  const createService = async (event: FormEvent) => {
    ...
    try {
      ...
      await refresh();
      toast({ title: "Imaging service added", variant: "success" });
    } catch (error) {
  ...
  const saveReport = async (event: FormEvent) => {
    ...
    try {
      ...
      await refresh();
      toast({ title: "Radiology report completed", variant: "success" });
    } catch (error) {
