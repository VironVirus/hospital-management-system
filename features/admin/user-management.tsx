...
const roleDescriptions: Record<AppRole, string> = {
  Admin: "Hospital configuration, staff, catalogue, audit, and full operational access.",
  Receptionist: "Registration, encounters, appointments, laboratory requests, and patient billing.",
  Doctor: "Clinical encounters, diagnoses, reports, prescriptions, and patient care.",
  Nurse: "Triage, vital signs, nursing notes, wards, beds, admissions, and discharge.",
  Pharmacist: "Medication catalogue, pharmacy stock, prescription review, and dispensing.",
  Storekeeper: "Hospital stores, stock receipts, issues, expiry, and reorder monitoring.",
  Radiologist: "Imaging requests, scheduling, examination workflow, findings, and radiology reports.",
  LabScientist: "Samples, laboratory worklists, results, quality control, and inventory.",
  Verifier: "Laboratory result review, verification, sample tracking, and reports.",
  Accountant: "Patient billing, accounts, revenue, expenses, and financial reporting."
};
