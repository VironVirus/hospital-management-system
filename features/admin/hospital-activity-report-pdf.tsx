...
export function HospitalActivityReportDocument({ report }: { report: HospitalActivityReport }) {
  const reportTitle = report.reportTitle || "Hospital activity report";
  return <Document title={reportTitle}><Page size="A4" orientation="landscape" style={styles.page} wrap>
