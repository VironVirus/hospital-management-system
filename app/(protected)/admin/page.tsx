...
import { Activity, BedDouble, Settings, TestTube2, Users } from "lucide-react";
...
export default function AdminPage() {
  ...
  if (!canAccessAdministrationRole(role)) return <Card><CardHeader><CardTitle>Access unavailable</CardTitle></CardHeader></Card>;
