...
export default function LoginPage() {
  ...
  return <Card className="border-blue-100 bg-white/90 shadow-xl shadow-blue-100/50 backdrop-blur">
    <CardHeader className="space-y-2"><CardTitle className="text-2xl text-slate-950">Staff sign in</CardTitle><CardDescription>Use the account created for you by the hospital Admin.</CardDescription></CardHeader>
    <CardContent><form className="space-y-4" onSubmit={handleSubmit}>
      ...
      <p className="text-center text-sm text-slate-600">There is no public signup. Contact the Admin for an account.</p>
    </form></CardContent>
  </Card>;
}
